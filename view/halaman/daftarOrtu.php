        ...
        <div class="card">
          ...
          <div class="card-body">
		    ...
		    <!--    <div class="form-group">
		        ...
		        <div class="form-group">
		          <label>Nama Wali</label>
		          <input type="text" class="form-control" name="nama_wali" value="<?= $row['Nama_Wali'] ?>">
		          <!-- Validation -->
		          <div class="valid-feedback"> Baguss! </div>
		          <div class="invalid-feedback"> Wajib Diisi! </div>
		          <!-- End Validation -->
		    ...
		    <!--    <div class="form-group">
		        ...
		        <div class="form-group">
		          <label>Tanggal Lahir Wali</label>
		          <input type="date" class="form-control" name="tanggal_lahir_wali" value="<?= $row['Tgl_Lahir_Wali'] ?>">
		          <!-- Validation -->
		          <div class="valid-feedback"> Baguss! </div>
		          <div class="invalid-feedback"> Wajib Diisi! </div>
		          <!-- End Validation -->
		        ...
		        <div class="form-group">
		          <label>Telepon Wali</label>
		          <input type="number" class="form-control" name="telepon_wali" value="<?= $row['Telepon_Wali'] ?>">
		          <!-- Validation -->
		          <div class="valid-feedback"> Baguss! </div>
		          <div class="invalid-feedback"> Wajib Diisi! </div>
		          <!-- End Validation -->
		        ...
		        <div class="form-group">
		          <label>Pendidikan Terakhir Wali</label>
		          <input type="text" class="form-control" name="pendidikan_terakhir_wali"  value="<?= $row['Pendidikan_Terakhir_Wali'] ?>">
		          <!-- Validation -->
		          <div class="valid-feedback"> Baguss! </div>
		          <div class="invalid-feedback"> Wajib Diisi! </div>
		          <!-- End Validation -->
		        ...
		        <div class="form-group">
		          <label>Pekerjaan Wali</label>
		          <input type="text" class="form-control" name="pekerjaan_wali" value="<?= $row['Pekerjaan_Wali'] ?>">
		          <!-- Validation -->
		          <div class="valid-feedback"> Baguss! </div>
		          <div class="invalid-feedback"> Wajib Diisi! </div>
		          <!-- End Validation -->
...
<!-- Footer -->
      ...
      <footer class="main-footer">
        <div class="footer-left">
        	Copyright &copy; 2025 <div class="bullet"></div> <a href="https://www.smkbinarahayu.sch.id/">SMK BINA RAHAYU</a>
        </div>
