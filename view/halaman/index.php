...
<html lang="en">
  ...
  ?>
    ...
    <div class="ftco-blocks-cover-1">
      ...
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('../../assets/style/images/hero_1.PNG')">
        <div class="container">
          <div class="row align-items-center ">

            <div class="col-md-5 mt-5 pt-5">
              <span class="text-cursive h5 text-red">Selamat datang di website kami.</span>
              <h1 class="mb-3 font-weight-bold text-teal">Penerimaan Taruna Baru</h1>
              <p>SMK BINA RAHAYU</p>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <!-- <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/18.jpg" data-fancybox="gal"><img src="../../assets/style/images/18.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
